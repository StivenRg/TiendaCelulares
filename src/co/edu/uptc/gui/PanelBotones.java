...
public class PanelBotones extends JPanel {
	...
	public PanelBotones(Evento evento) {
		...
		JButton accion5= new JButton(Evento.LIMPIAR_LOG);
		accion5.addActionListener(evento);
		accion5.setActionCommand(Evento.LIMPIAR_LOG);

		JButton accion6= new JButton(Evento.SALIR);
		accion6.addActionListener(evento);
		accion6.setActionCommand(Evento.SALIR);
